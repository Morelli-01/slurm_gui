...
def get_dark_theme_stylesheet():
    return f"""
        ...
        QTabBar::tab {{
            ...
            color: {COLOR_DARK_FG};
            border: 1px solid {COLOR_DARK_BORDER};
            border-bottom-color: {COLOR_DARK_BORDER}; /* same as pane border */
        ...
        QTabBar::tab:selected, QTabBar::tab:hover {{
            background: {COLOR_DARK_BG_HOVER};
        }}
        QTabBar::tab:selected {{
            border-color: {COLOR_BLUE};
            border-bottom-color: {COLOR_DARK_BG_HOVER}; /* make the selected tab look like it's connected to the pane */
        }}
        QTabBar::tab:!selected {{
    ...
    return f"""
        ...
        QGroupBox {{
            ...
            QTableWidget {{
                ...
                selection-color: {COLOR_LIGHT_FG};
                border: 1px solid {COLOR_LIGHT_BORDER};
                border-radius: 5px;
                gridline-color: {COLOR_LIGHT_BORDER};
                font-size: 14px;
            }}
            QHeaderView::section {{
        ...
        QTabBar::tab {{
            background: {COLOR_LIGHT_BG_ALT};
            color: {COLOR_LIGHT_FG};
            border: 1px solid {COLOR_LIGHT_BORDER};
            border-bottom-color: {COLOR_LIGHT_BORDER}; /* same as pane border */
            border-top-left-radius: 4px;
            border-top-right-radius: 4px;
            min-width: 8ex;
            padding: 5px;
        ...
        QTabBar::tab:selected, QTabBar::tab:hover {{
            background: {COLOR_LIGHT_BG_HOVER};
        }}
        QTabBar::tab:selected {{
            border-color: {COLOR_BLUE};
            border-bottom-color: {COLOR_LIGHT_BG_HOVER}; /* make the selected tab look like it's connected to the pane */
        }}
        QTabBar::tab:!selected {{
            margin-top: 2px; /* make non-selected tabs look smaller */
        }}
        ...
        QProgressBar#cpuUsageBar::chunk[crit="true"] {{
            background-color: {BLOCK_COLOR_MAP['high-constraint']};
        }}
        QProgressBar#cpuUsageBar::chunk[warn="true"] {{
            background-color: {BLOCK_COLOR_MAP['mid-constraint']};
        }}
        QProgressBar#ramUsageBar::chunk[crit="true"] {{
            background-color: {BLOCK_COLOR_MAP['high-constraint']};
        }}
